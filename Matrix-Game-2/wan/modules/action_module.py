...
class ActionModule(nn.Module):
    ...
    def forward(self, x, tt, th, tw, mouse_condition=None, keyboard_condition=None, block_mask_mouse=None, block_mask_keyboard=None, is_causal=False, kv_cache_mouse=None, kv_cache_keyboard=None, start_frame=0, use_rope_keyboard=True, num_frame_per_block=3):
        ...
        if self.enable_mouse and mouse_condition is not None:
            with nvtx_range("action_mouse_setup", enabled=nvtx_enabled):
        ...
        if self.enable_mouse and mouse_condition is not None:
            with nvtx_range("action_mouse_prep", enabled=nvtx_enabled):
            ...
            # qkv
            with nvtx_range("action_mouse_qkv", enabled=nvtx_enabled):
            ...
            with nvtx_range("action_mouse_attn", enabled=nvtx_enabled):
                if is_causal:
            ...
            with nvtx_range("action_mouse_proj", enabled=nvtx_enabled):
        ...
        if self.enable_keyboard and keyboard_condition is not None:
            with nvtx_range("action_keyboard_prep", enabled=nvtx_enabled):
            ...
            with nvtx_range("action_keyboard_qkv", enabled=nvtx_enabled):
            ...
            if use_rope_keyboard: 
                with nvtx_range("action_keyboard_attn_rope", enabled=nvtx_enabled):
                    B, TS, H, D = q.shape
                    T_ = TS // S 
                ...
                with nvtx_range("action_keyboard_attn", enabled=nvtx_enabled):
                    if is_causal:
                        if kv_cache_keyboard is None:
            ...
            with nvtx_range("action_keyboard_proj", enabled=nvtx_enabled):
